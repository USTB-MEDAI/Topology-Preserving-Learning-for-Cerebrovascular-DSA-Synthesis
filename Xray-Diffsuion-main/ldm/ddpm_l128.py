...
import torch.nn.functional as F  #4.4mdf
...
class LatentDiffusion(DDPM):
    ...
    def p_losses(self, x_start, cond, t, noise=None):
        ...
        loss_simple = self.get_loss(model_output, target, mean=False).mean([1, 2, 3])  #mdf , 4
        ...
        loss_vlb = self.get_loss(model_output, target, mean=False).mean(dim=(1, 2, 3))  #mdf , 4
